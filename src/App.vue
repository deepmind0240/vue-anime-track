...
<template>
	<main>
		<h1 class="text">Track your Anime</h1>
		...
		<div class="results" v-if="search_results.length > 0">
			<div v-for="anime in search_results" class="result" :key="anime.title">
		...
		<div class="myanime" v-if="my_anime.length > 0">
			<h2 class="text textCenter">My Anime</h2>

			<div v-for="anime in my_anime_asc" class="anime" :key="anime.title">
				<img :src="anime.image" />
				<h3>{{ anime.title }}</h3>
...
.button {
	...
	display: block;
	padding: 0.5rem 1rem;
	background-image: linear-gradient(to right, rgb(166, 106, 206) 50%, darkviolet 50%);
	background-size: 200%;
